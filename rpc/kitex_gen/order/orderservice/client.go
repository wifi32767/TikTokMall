...
type Client interface {
	...
	UpdateOrderState(ctx context.Context, Req *order.UpdateOrderStateReq, callOptions ...callopt.Option) (r *order.Empty, err error)
}
...
func (p *kOrderServiceClient) UpdateOrderState(ctx context.Context, Req *order.UpdateOrderStateReq, callOptions ...callopt.Option) (r *order.Empty, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
