...
func (p *kClient) AddItem(ctx context.Context, Req *cart.AddItemReq) (r *cart.Empty, err error) {
...
func (p *kClient) EmptyCart(ctx context.Context, Req *cart.EmptyCartReq) (r *cart.Empty, err error) {
