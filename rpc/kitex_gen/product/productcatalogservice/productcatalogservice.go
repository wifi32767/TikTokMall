...
var UpdateProductResult_Success_DEFAULT *product.Empty
...
func (p *UpdateProductResult) GetSuccess() *product.Empty {
	if !p.IsSetSuccess() {
...
var DeleteProductResult_Success_DEFAULT *product.Empty
...
func (p *DeleteProductResult) GetSuccess() *product.Empty {
	if !p.IsSetSuccess() {
...
func (p *kClient) UpdateProduct(ctx context.Context, Req *product.UpdateProductReq) (r *product.Empty, err error) {
...
func (p *kClient) DeleteProduct(ctx context.Context, Req *product.DeleteProductReq) (r *product.Empty, err error) {
